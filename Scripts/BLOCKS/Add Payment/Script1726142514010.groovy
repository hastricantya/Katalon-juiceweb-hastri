...
WebUI.setText(findTestObject('NEW/Page_OWASP Juice Shop/input_cardnumber'), 'hastri')

WebUI.click(findTestObject('NEW/Page_OWASP Juice Shop/click_card'))

WebUI.setText(findTestObject('NEW/Page_OWASP Juice Shop/input_Namecredit'), '1234567812345678')
