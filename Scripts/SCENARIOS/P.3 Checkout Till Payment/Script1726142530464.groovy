...
WebUI.callTestCase(findTestCase('BLOCKS/Address and Delivery'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('BLOCKS/Add Payment - Copy'), [:], FailureHandling.STOP_ON_FAILURE)
